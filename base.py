...
section_messages = {
    "ویدئوهای آموزشی": "این بخش ویدئوهای اموزشی درحال تکمیل است",
    "جزوه اساتید": "این بخش جزوه اساتید درحال تکمیل است",
    "نظرسنجی ها": "این بخش نظرسنجی ها درحال تکمیل است.",
    "عضویت در انجمن": "این بخش عضویت در انجمن درحال تکمیل است.",
    "نشریه": "این بخش نشریه ها درحال تکمیل است.",
    "کارگاه ها": "این بخش کارگاه ها درحال تکمیل است.",
    "اضافه کردن ویدئو": "این بخش اضافع کردن ویدئو درحال تکمیل است.",
    "اضافه کردن جزوه": "این بخش اضافه کردن جزوه درحال تکمیل است.",
    "اطلاعیه": "این بخش اطلاعیه ها درحال تکمیل است.",
    "نشریه ها": "این بخش نشریه ها درحال تکمیل است.",
    "کارگاه": "این بخش کارگاه درحال تکمیل است.",
